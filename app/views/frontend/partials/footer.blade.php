    ...
    <div class="row follow">
        <div class="columns">
            ...
            <ul class="f-social small-block-grid-3 medium-block-grid-3 large-block-grid-4">
                ...
                <li class="">
                    <a target="_blank" class="f-social-link"
                       href="https://www.facebook.com/BorisVargasDisenadorGraficoYWebFreelance">
...
<footer class="l-footer l-footer-slogan">
    <div class="row slogan">
        <div class="columns">
            <a href="/">
                <img class="slogan-logo" src="{{ asset('assets/images/logo-small-light.svg') }}"
                     alt="Boris Vargas - Graphic Design">
            </a>
            <nav>
