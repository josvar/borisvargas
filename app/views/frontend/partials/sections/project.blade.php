<div class="row">
    <div class="columns medium-6 medium-centered large-6 large-centered">
        <div class="text_presentation text_presentation-project">
            ...
            <p class="text_presentation-p">We are Temply. We sell high-end, ready to print Indesign templates to
                ...
                we have the template for you. Or just need a document with the legwork already done,
